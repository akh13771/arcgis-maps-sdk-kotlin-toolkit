...
buildscript {
    ...
    println("debug: (builds): artifactoryUrl: $artifactoryUrl")
    println("debug: (builds): artifactoryUsername: $artifactoryUsername")
    println("debug: (builds): artifactoryPassword: $artifactoryPassword")
